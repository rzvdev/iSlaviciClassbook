...
{
    public class DGVimageButtonDeleteColumn : DataGridViewButtonColumn
    {
        public DGVimageButtonDeleteColumn()
        {
            CellTemplate = new DataGridViewImageDeleteCell();
            Width = 100;
        }
    }

    public class DataGridViewImageDeleteCell : DataGridViewImageButtonCell
    {
        public override void LoadImages()
        {
            // The normal Save image
            byte[] normalArray = IconToBytes(Properties.Resources.dgvUserListDeleteBtn_24px);
...
public abstract class DataGridViewImageButtonCell : DataGridViewButtonCell
{
        ...
        DataGridViewPaintParts paintParts)
    {
        ...
        ButtonRenderer.DrawButton(graphics, buttonArea, _buttonImageNormal, imageArea, false, PushButtonState.Normal);
    }
